...
class CourseControllerTest {
    ...
    public void createBasicData() {
        ...
        initialMinigameTask =
            course.getWorlds().stream().findFirst().get().getMinigameTasks().stream().findFirst().get();
    ...
    void getCourse() throws Exception {
        final MvcResult result = mvc
            .perform(
                get(fullURL + "/" + initialCourseDTO.getId()).cookie(cookie).contentType(MediaType.APPLICATION_JSON)
            )
    ...
    void updateCourse() throws Exception {
        ...
        final CourseDTO updatedCourse = objectMapper.readValue(
            result.getResponse().getContentAsString(),
            CourseDTO.class
        );
    ...
    void deleteCourse() throws Exception {
        final MvcResult result = mvc
            .perform(
                delete(fullURL + "/" + initialCourseDTO.getId()).cookie(cookie).contentType(MediaType.APPLICATION_JSON)
            )
            .andExpect(status().isOk())
            .andReturn();
