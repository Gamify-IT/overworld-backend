...
public class ShopService {
    ...
    public void setupShopItems() {
        List<ShopItem> shopItems = Arrays.asList(
            new ShopItem(ShopItemID.FLAME_HAT, 140, "hat0", ShopItemCategory.ACCESSORIES, false),
            new ShopItem(ShopItemID.GLOBE_HAT, 120, "hat1", ShopItemCategory.ACCESSORIES, false),
            new ShopItem(ShopItemID.SAFETY_HELMET, 120, "hat2", ShopItemCategory.ACCESSORIES, false),
            new ShopItem(ShopItemID.BLONDE, 70, "hat3", ShopItemCategory.ACCESSORIES, false),
            new ShopItem(ShopItemID.CINEMA_GLASSES, 100, "glasses0", ShopItemCategory.ACCESSORIES, false),
            new ShopItem(ShopItemID.COOL_GLASSES, 100, "glasses1", ShopItemCategory.ACCESSORIES, false),
            new ShopItem(ShopItemID.HEART_GLASSES, 90, "glasses2", ShopItemCategory.ACCESSORIES, false),
            new ShopItem(ShopItemID.RETRO_GLASSES, 90, "glasses3", ShopItemCategory.ACCESSORIES, false),
            new ShopItem(ShopItemID.SPORTS, 160, "character3", ShopItemCategory.OUTFIT, false),
            new ShopItem(ShopItemID.SUIT, 200, "character4", ShopItemCategory.OUTFIT, false),
            new ShopItem(ShopItemID.BLUE_SHIRT, 160, "character5", ShopItemCategory.OUTFIT, false),
            new ShopItem(ShopItemID.LONGHAIR, 100, "character6", ShopItemCategory.OUTFIT, false),
            new ShopItem(ShopItemID.TITANIUM_KNIGHT, 270, "character7", ShopItemCategory.OUTFIT, false),
            new ShopItem(ShopItemID.SANTA_COSTUME, 240, "character8", ShopItemCategory.OUTFIT, false)
        );
