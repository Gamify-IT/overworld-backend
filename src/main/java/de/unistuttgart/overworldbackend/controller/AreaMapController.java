...
public class AreaMapController {
    ...
    public AreaMapDTO getAreaMapFromDungeon(
        ...
        return areaMapMapper.areaMapToAreaMapDTO(
            areaMapService.getAreaMapFromDungeon(courseId, worldIndex, dungeonIndex)
        );
    }
    ...
    public AreaMapDTO updateAreaMapFromDungeon(
        ...
        jwtValidatorService.hasRolesOrThrow(accessToken, LECTURER_ROLE);
        log.debug(
            "update area map from dungeon {} from world {} of course {} with {}",
            dungeonIndex,
            worldIndex,
            courseId,
            areaMapDTO
